...
const EMBEDDED_INSTALL_SCRIPT = `#!/usr/bin/env bash
...
export async function GET() {
  let scriptContent = EMBEDDED_INSTALL_SCRIPT;
  ...
  try {
    ...
    // Use embedded fallback if filesystem read is unavailable in edge/serverless runtime
  }
